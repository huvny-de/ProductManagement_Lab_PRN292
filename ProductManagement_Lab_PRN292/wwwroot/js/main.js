...
if(window.pageYOffset>sticky){header_navbar.classList.add("sticky");logo.src='~/images/logo/logo-2.svg';}else{header_navbar.classList.remove("sticky");logo.src='~/images/logo/logo.svg';}
